...
public class SubNode extends TemplateNode {

    GLDataType target_type = GLDataType.INT;

    public SubNode(JsonObject initialization_data) {
        super("Sub", FunctionDirective.SUB, GLDataType.INT, initialization_data);
