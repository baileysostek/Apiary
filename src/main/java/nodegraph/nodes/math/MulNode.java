...
public class MulNode extends TemplateNode {

    GLDataType target_type = GLDataType.INT;

    public MulNode(JsonObject initialization_data) {
        super("Mul", FunctionDirective.MUL, GLDataType.INT, initialization_data);
